...
def register(request,
             ...
             registered_user_redirect_to= "../profile",
...
def activation_complete(request,
    ...
    return TemplateResponse(request, template_name, context)
'''
def profilea(request, template_name='users/profile.html',
                          uidb64=None,
                        current_app=None,
                        extra_context=None):
...
def profile(request, template_name='users/profile.html',
                        ...
                        extra_context=None):
    usmail = request.user
    todolist = Todo.objects.filter(remind_receiver_email = usmail)
    return render_to_response(template_name,{'todolist': todolist})
